  ...
  return (
    <section className="relative w-dvw h-dvh bg-radial-[circle_at_50%_50%] from-[#E0C337] from-50% to-[#9F671E] to-100%">
      <div className="relative -top-5 sm:top-0 py-8 sm:py-0 flex flex-col justify-center items-center w-full h-full">
        ...
        ></img>
        <div className="flex flex-col gap-3 h-[60%] w-[90%]">
          <img
            src={rcheckImages[0].src}
            className="w-full h-48 sm:h-auto object-cover shadow-[0_5px_20px_rgba(0,0,0,0.40)] transition-transform duration-300 hover:scale-[1.05]"
          />
          <img
