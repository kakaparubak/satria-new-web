    ...
    >
      <div className="relative">
        ...
        <button
          ref={closeBtnRef}
          onClick={handleClose}
          className="absolute top-0 right-0 w-10 h-10 rounded-full bg-black text-white flex items-center justify-center cursor-pointer hover:scale-110 transition-transform"
