    ...
    >
      <div className="relative max-w-[90%] max-h-[90%]">
        <img
          ref={imageRef}
          src={src}
          className="rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.5)]"
...
`}</style>
        <button
          ref={closeBtnRef}
          onClick={handleClose}
          className="lightbox-close-btn absolute top-0 right-0 w-6 h-6 lg:w-10 lg:h-10 rounded-full bg-black text-white flex items-center justify-center cursor-pointer hover:scale-110 transition-transform"
