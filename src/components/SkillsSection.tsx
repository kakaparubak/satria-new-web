    ...
    <section className="w-dvw h-dvh bg-radial-[circle_at_50%_50%] from-27% from-[#992729] via-63% via-[#EE3A3D] to-105% to-[#7C1C1E]">
      <div className="w-full h-auto sm:h-full px-[4%] py-[6%] flex flex-col items-center justify-center gap-6">
        ...
        <div className="w-full h-[120px] sm:h-full justify-center flex items-end gap-3 @container-size">
          {/* Mobile: stacked image top + text bottom | Desktop: text left + image+text right */}
          <div className="hidden sm:block w-1/2 h-full items-center">
            <p className="text-shadow-[0_5px_20px_rgba(0,0,0,0.40)] font-inter font-semibold text-[6cqw] tracking-tighter leading-none">
              DESIGN
            </p>
          </div>
          <div className="w-full sm:w-1/2 h-full flex flex-col sm:flex-row">
            <img
            ...
            <div className="flex justify-center items-center h-1/2 sm:h-full sm:w-1/2 bg-[#F3F3F3]">
              <p className="leading-tight text-black p-[10%] font-inter text-right text-base sm:text-xl lg:text-base font-medium tracking-tighter">
        ...
        {/* PRE-VISUALIZER */}
        <div className="w-full h-[120px] sm:h-full justify-center flex items-end gap-3 @container-size">
          {/* Mobile: stacked image top + text bottom | Desktop: image+text left + text right */}
          <div className="w-full sm:w-1/2 h-full flex flex-col sm:flex-row-reverse">
            <img
              className="h-1/2 sm:h-full sm:w-1/2 object-cover"
            ...
            <div className="flex justify-center items-center h-1/2 sm:h-full sm:w-1/2 bg-[#1B1B1B]">
              <p className="leading-tight text-[#EAEAEA] p-[10%] font-inter text-left text-base sm:text-xl lg:text-base font-medium tracking-tighter">
        ...
        <div className="w-full h-[120px] sm:h-full justify-center flex gap-3 @container-size">
          ...
          <div className="w-full sm:w-1/2 h-full flex flex-col sm:flex-row">
            ...
            ></img>
            <div className="flex justify-center items-center h-1/2 sm:h-full sm:w-1/2 bg-[#1B1B1B]">
              <p className="leading-tight text-[#EAEAEA] p-[10%] font-inter text-right text-base sm:text-xl lg:text-base font-medium tracking-tighter">
        ...
        <div className="w-full h-[120px] sm:h-full justify-center flex gap-3 @container-size">
          ...
          <div className="w-full sm:w-1/2 h-full flex flex-col sm:flex-row-reverse">
            ...
            ></img>
            <div className="flex justify-center items-center h-1/2 sm:h-full sm:w-1/2 bg-[#F3F3F3]">
              <p className="leading-tight text-black p-[10%] font-inter text-left text-base sm:text-xl lg:text-base font-medium tracking-tighter">
