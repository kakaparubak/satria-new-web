    ...
    <section className="w-dvw h-dvh bg-radial-[circle_at_50%_50%] from-27% from-[#992729] via-63% via-[#EE3A3D] to-105% to-[#7C1C1E]">
      <div className="w-full h-full px-[4%] py-[6%] flex flex-col items-center justify-center gap-6">
        <div className="w-full h-full justify-center flex items-end gap-3 @container-size">
          <p className="text-shadow-[0_5px_20px_rgba(0,0,0,0.40)] font-inter font-semibold h-1/2 text-[6cqw] tracking-tighter leading-none">
            DESIGN
          </p>
        ...
        <div className="w-full h-full justify-center flex items-end gap-3 @container-size">
          ...
          <p className="text-shadow-[0_5px_20px_rgba(0,0,0,0.40)] font-inter text-nowrap font-semibold h-1/2 text-[6cqw] tracking-tighter leading-none">
            PRE-VISUALIZER
          </p>
        </div>
