...
export type Projects = Node & Document & {
  ...
  imgs?: Maybe<Array<Maybe<Scalars['String']['output']>>>;
...
export type ProjectsMutation = {
  ...
  imgs?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
...
export type ProjectsQuery = { __typename?: 'Query', projects: { __typename: 'Projects', id: string, name: string, date?: string | null, imgs?: Array<string | null> | null, desc?: string | null, _sys: { __typename?: 'SystemInfo', filename: string, basename: string, hasReferences?: boolean | null, breadcrumbs: Array<string>, path: string, relativePath: string, extension: string } } };
